<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			...
			<?php $status_arr = array("Item Accepted by Courier","Shipment Plan Started","Shipment in transit","In-Transit","Arrived At Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","On-Hold"); ?>
