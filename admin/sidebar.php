        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php 
              $status_arr = array("Item Accepted<br/>by Courier","Shipment Plan Started","Shipment in transit","In-Transit","Arrived At<br/>Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","On-Hold");
