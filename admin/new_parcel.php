...
<style>
  ...
  /* Make sure tables are responsive on smaller screens */
  .table-responsive {
    overflow-x: auto;
  }
</style>
      ...
      <form action="" id="manage-parcel">
        ...
        <div class="col-md-6 mb-4">
          <div class="form-group">
            <label for="" class="control-label"><b>Parcel Id</b></label>
            <input type="text" max="10" name="reference_number" id="" class="form-control form-control-sm" value="<?php echo $reference_number; ?>" required>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="sender_country" id="" class="form-control form-control-sm" value="<?php echo isset($sender_country) ? $sender_country : '' ?>" required>
            </div>
            <div class="form-group">
              <label for="" class="control-label">City / State</label>
              <input type="text" name="sender_state" id="" class="form-control form-control-sm" value="<?php echo isset($sender_state) ? $sender_state : '' ?>" required>
            </div>
            <div class="form-group">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label for="" class="control-label">Country</label>
              <input type="text" name="recipient_country" id="" class="form-control form-control-sm" value="<?php echo isset($recipient_name) ? $recipient_name : '' ?>" required>
            </div>
            <div class="form-group">
              <label for="" class="control-label">City / State</label>
              <input type="text" name="recipient_state" id="" class="form-control form-control-sm" value="<?php echo isset($recipient_state) ? $recipient_state : '' ?>" required>
            </div>
            <div class="form-group">
              <label for="" class="control-label">Address</label>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label for="" class="control-label">Shipment Mode</label>
              <input type="text" name="shipment_method" id="" class="form-control form-control-sm" value="<?php echo isset($shipment_method) ? $shipment_method : '' ?>" required>
            </div>

            <div class="form-group">
              <label for="" class="control-label">Type of package</label>
              <input type="text" name="type_of_package" id="" class="form-control form-control-sm" value="<?php echo isset($type_of_package) ? $type_of_package : '' ?>" required>
            </div>
          </div>
          ...
          <div class="col-md-6" id="" <?php echo isset($type) && $type == 1 ? 'style="display: none"' : '' ?>>
            ...
            <div class="form-group">
              ...
              <input type="date" name="estimated_date" id="" class="form-control form-control-sm" value="<?php echo isset($estimated_date) ? $estimated_date : '' ?>" required>
            </div>
          </div>
        </div>
...
$('#manage-parcel').submit(function(e){
  ...
  var quantity = $('#parcel-items tbody tr').length;
...
// Your existing calc() function to handle price calculations
function calc() {
  var total = 0;
